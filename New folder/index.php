...
<html>
<head>
	<title>Tugas Kelompok CRUD Database<</title>
</head>
<body>
	<h2>Tugas Kelompok CRUD Database</h2>
	...
	<table cellpadding="5" cellspacing="0" border="1">
		...
		$query = mysqli_query($koneksi, "SELECT * FROM siswa ORDER BY siswa_nis DESC") or die(mysqli_error());
